    ...
    <nav v-if="isAuthenticated" class="navbar navbar-dark bg-dark fixed-top">
      <div class="container">
        ...
        <div class="navbar-nav flex-row gap-3">
          ...
          <router-link v-if="user && (user.role === 'admin' || user.role === 'manager')" class="nav-link" to="/admin/users">User Management</router-link>
        </div>
        <div class="navbar-nav flex-row gap-2 ms-auto align-items-center">
          ...
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><router-link v-if="user && (user.role === 'admin' || user.role === 'manager')" class="dropdown-item" to="/admin/users">User Management</router-link></li>
