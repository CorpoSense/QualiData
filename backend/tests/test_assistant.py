...
class TestPreflightReturnsConsistentOps:
    ...
    async def test_preflight_ops_match_available_ops(self):
        ...
        expected = {"fillna", "remove-duplicates", "find-replace", "extract-json", "extract-pattern", "string-operations", "fuzzy-match", "one-hot-encoding", "label-encoding", "value-mapping", "binning"}
