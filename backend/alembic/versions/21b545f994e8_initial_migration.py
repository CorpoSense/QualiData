...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_operation_history_created_at"),
        "operation_history",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_operation_history_project_id"),
        "operation_history",
        ["dataset_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column(
            "provider", sa.String(length=50), nullable=False, server_default="openai"
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_operation_history_project_id"), table_name="operation_history"
    )
    op.drop_index(
        op.f("ix_operation_history_created_at"), table_name="operation_history"
    )
